...
LifeState LifeStableState::Vulnerable() const {
  ...
  LifeState new_vulnerable_center(false);
...
#include "bitslicing/stable_vulnerable.hpp"
    ...
    new_vulnerable_center[i] = vulnerable_center;
  }

  return (new_vulnerable.ZOI() & ~new_vulnerable) | new_vulnerable_center;
}
