...
abort |= (~stateon) & on1 & on0 & (~unk2) & (~unk1) & (~unk0);
abort |= stateon & on1 & (~on0) & (~unk2) & (~unk1) & (~unk0);
abort |= stateon & (~on1) & on0 & (~unk3) & (~unk2) & (~unk1);
d5 |= stateunk & (~on2) & (~on1) & unk2 & (~unk1) & (~unk0);
d6 |= stateunk & (~on2) & (~on0) & unk2 & (~unk1) & (~unk0);
l2 |= stateunk & (~on1) & (~on0) & (~unk2) & unk1 & (~unk0);
d2 |= stateunk & (~on1) & (~on0) & (~unk2) & unk1 & (~unk0);
d4 |= stateunk & (~on2) & (~on0) & (~unk2) & unk1 & (~unk0);
d6 |= stateunk & (~on1) & on0 & (~unk1) & unk0;
d5 |= stateunk & (~on2) & (~on1) & (~on0) & (~unk3) & (~unk1);
d5 |= (~on2) & (~on1) & (~on0) & (~unk3) & (~unk1) & (~unk0);
d6 |= stateunk & (~on1) & (~on0) & unk1 & (~unk0);
d2 |= stateunk & on0 & (~unk2) & (~unk1) & unk0;
d4 |= stateunk & on0 & (~unk2) & (~unk1) & unk0;
d5 |= stateunk & (~on2) & (~unk2) & unk1 & (~unk0);
d4 |= stateunk & (~on2) & (~on1) & (~unk3) & (~unk2);
d6 |= (~on2) & (~on1) & (~unk3) & (~unk1) & (~unk0);
abort |= stateon & on2 & on1;
d5 |= stateunk & (~on2) & (~on0) & (~unk3) & (~unk2);
d6 |= (~on2) & (~on1) & (~on0) & (~unk3) & (~unk1);
abort |= stateon & on2 & on0;
d5 |= (~on2) & (~on0) & (~unk3) & (~unk2) & (~unk0);
d1 |= stateunk & (~on0) & (~unk3) & (~unk2) & (~unk1);
d5 |= stateunk & (~on0) & (~unk3) & (~unk2) & (~unk1);
d1 |= (~on0) & (~unk3) & (~unk2) & (~unk1) & (~unk0);
d5 |= (~on0) & (~unk3) & (~unk2) & (~unk1) & (~unk0);
l3 |= on0 & (~unk3) & (~unk2) & (~unk1) & (~unk0);
d2 |= on0 & (~unk3) & (~unk2) & (~unk1) & (~unk0);
d6 |= on0 & (~unk3) & (~unk2) & (~unk1) & (~unk0);
l3 |= (~on2) & (~on1) & (~unk3) & (~unk2) & (~unk0);
d4 |= (~on2) & (~on1) & (~unk3) & (~unk2) & (~unk0);
l2 |= (~stateon) & on1 & on0;
d2 |= (~stateon) & on1 & on0;
l3 |= (~on2) & (~on1) & (~on0) & (~unk3) & (~unk2);
d4 |= (~on2) & (~on1) & (~on0) & (~unk3) & (~unk2);
d2 |= (~on1) & (~on0) & (~unk3) & (~unk2) & (~unk1);
d6 |= (~on1) & (~on0) & (~unk3) & (~unk2) & (~unk1);
l3 |= (~on2) & (~on0) & (~unk3) & (~unk2) & (~unk1);
d4 |= (~on2) & (~on0) & (~unk3) & (~unk2) & (~unk1);
l2 |= (~on2) & (~on1) & (~unk3) & (~unk2) & (~unk1);
l3 |= (~on2) & (~on1) & (~unk3) & (~unk2) & (~unk1);
d4 |= (~on2) & (~on1) & (~unk3) & (~unk2) & (~unk1);
l2 |= (~stateunk) & (~on1) & (~on0);
d6 |= stateunk & (~on2) & (~unk3) & (~unk2);
d6 |= (~on2) & (~unk3) & (~unk2) & (~unk0);
d6 |= (~on2) & (~on0) & (~unk3) & (~unk2);
l2 |= (~stateunk) & (~stateon);
l3 |= (~stateunk) & (~stateon);
d5 |= (~on2) & (~on1) & (~unk3) & (~unk2);
d6 |= (~on2) & (~on1) & (~unk3) & (~unk2);
d5 |= (~on2) & (~unk3) & (~unk2) & (~unk1);
d6 |= (~on2) & (~unk3) & (~unk2) & (~unk1);
d4 |= on2 & on0;
d4 |= on2 & on1;
d5 |= on2 & on1;
l2 |= (~stateon) & on2;
...
signaloff |= l2 & l3 & d4 & d5 & s1 & (~s0) & (~unk2);
signalon |= (~l2) & d0 & d1 & (~s1) & (~s0) & (~unk2) & unk0;
signalon |= l2 & d1 & d5 & s0 & (~unk2) & (~unk1) & unk0;
signalon |= l2 & d1 & d2 & d5 & d6 & (~s1) & s0 & (~unk2) & unk0;
signalon |= d0 & d1 & d2 & d4 & (~s2) & (~s1) & (~s0) & (~unk1) & unk0;
signalon |= l3 & d0 & d2 & d4 & d6 & (~s0) & (~unk2) & (~unk1) & unk0;
signalon |= l2 & d0 & d1 & d2 & (~s2) & (~s0) & (~unk2) & unk1 & (~unk0);
signalon |= d0 & d1 & d2 & (~s2) & (~s1) & (~s0) & unk2 & (~unk1) & (~unk0);
signalon |= l2 & l3 & d1 & d2 & d4 & d5 & (~s2) & s0 & (~unk2) & unk0;
signalon |= l2 & l3 & d0 & d1 & d2 & d4 & (~s2) & (~s0) & (~unk2) & unk0;
signalon |= l2 & l3 & d1 & d2 & d4 & d5 & (~s1) & s0 & (~unk1) & unk0;
signalon |= d0 & d1 & d2 & d4 & d5 & (~d6) & (~s1) & (~s0) & unk1 & (~unk0);
signalon |= l2 & l3 & d1 & d2 & d4 & (~s2) & s0 & (~unk2) & unk1 & (~unk0);
signalon |= l3 & d0 & d1 & d4 & d5 & (~s1) & (~s0) & (~unk2) & unk1 & (~unk0);
signalon |= l2 & l3 & d1 & d2 & d4 & (~s2) & (~s1) & s0 & unk2 & (~unk1) & (~unk0);
signalon |= l2 & l3 & d0 & d1 & d2 & d4 & d5 & (~s2) & (~s0) & unk2 & (~unk1) & (~unk0);
// End Autogenerated
